...
<!-- Bootstrap core CSS -->
  ...
  <script src="<?= base_url() ?>static/js/listadeseos.js"></script>
...
<!-- Navigation -->
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <div class="jumbotron jumbotron-fluid">
      <p align="center" style="color: black; font-family: Century Gothic; font-size: 27pt"  >Mi lista de deseos</p>
      <br/>
    </div>
      <div class="jumbotron jumbotron-fluid">
      <table class="table table-borderless" id="table-deseos">
      <thead>
        <tr>
          <th scope="col"></th>
          <th scope="col" style="font-size: 18pt;">Articulo</th>
          <th scope="col" style="font-size: 18pt;">Precio</th>
          <th scope="col" style="font-size: 18pt;">Categoria</th>
          <th scope="col" ></th>
        </tr>
      </thead>
      <tbody>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Eliminar de mi lista</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
        ¿Realmente deseas borrar el articulo <strong id="modal-borrar-articulo"></strong> de tu lista?
        </div>
        ...
        Cancelar
          ...
          <button type="button" class="btn btn-info" id="btn-borrar-confirmar">
