...
<body style="background-color:#b9c1ca;">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <div class="container">
      ...
      <p align="center" style="color: black; font-family: Century Gothic; font-size: 27pt" >Mis compras</p>
      <br/>
    </div>

          <!-- lista compras -->
        <div class="jumbotron jumbotron-fluid">
            <table class="table table-borderless" id="table-compras">
            <thead>
              <tr>
                <th scope="col" style="font-size: 15pt;">Vista Previa</th>
