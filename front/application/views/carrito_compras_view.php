...
<body style="background-color:#b9c1ca;">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <div class="jumbotron jumbotron-fluid">
      <p align="center" style="color: black; font-family: Century Gothic; font-size: 27pt"  >Mi carrito</p>
      <br/>
    </div>
        <div class="jumbotron jumbotron-fluid">
        <div class="row">
          ...
          <div class="col-lg-9" align="left">
            <table class="table table-borderless" id="table-carrito">
            <thead>
              <tr>
                <th scope="col"></th>
                ...
                <th scope="col" style="font-size: 15pt;"></th>
              </tr>
            </thead>
            <tbody>
            </tbody>
          ...
          <!-- resumen pedido -->
          <div class="col-lg-3" align="left" id="resumen" >
          </div>
 ...
 <footer class="text-center text-white" style="background-color: #f1f1f1;">
  ...
  <!-- Modal -->
  <div class="modal fade" id="modal-borrar"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Eliminar de tu carrito</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
          <div class="modal-body">
          ¿Realmente deseas borrar <strong id="modal-borrar-articulo"></strong> del carrito?
          </div>
